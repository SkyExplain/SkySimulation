...
# #-------------------------------------------------------------------------------------
omega_cdms = np.linspace(0.1, 0.15, 15)   #Planck: omega_cdm = 0.12011, #change for 15 elements
omega_bs = np.linspace(0.021, 0.023, 15)  #Planck: omega_b = 0.049 #change for 15 elements
...
omega_cdms = np.linspace(0.1, 0.15, 15) #change for 15 elements
A_lins = np.linspace(0.01, 0.06, 15) ##change for 15 elements
...
for omega_cdm in omega_cdms:
    for A_lin in A_lins:
        ...
        output_spct_f = "/mnt/netapp1/Store_CSIC/home/csic/eoy/ioj/SkySimulation/data/simulated_data/simulated_ang_power_spectra/polarization/"
        ...
        output_feature = "/mnt/netapp1/Store_CSIC/home/csic/eoy/ioj/SkySimulation/data/simulated_data/simulated_maps/polarization/"
